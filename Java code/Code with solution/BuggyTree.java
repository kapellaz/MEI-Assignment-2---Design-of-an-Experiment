...
class ConstructAVLTree {
    ...
    // Bug #2: Incorrectly calculates max height. Should be > comparison instead of
    // >=
    ...
    private int getTotalNumberOfNodes(Node head) {
        if (head == null)
            ...
            // #Bug 3: Unnecessary work - Recalculating the height for the entire subtree.
    ...
    // Bug #4: Logic bug. Recursive call not necessary here, since the loop
